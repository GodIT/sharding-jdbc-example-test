...
public class ItemRepositoryImpl implements ItemRepository {
    ...
    public void delete(final Long orderId) {
        Query query = entityManager.createQuery("DELETE FROM ItemEntity o WHERE o.itemId = ?1");
    ...
    public List<Item> selectAll() {
        return (List<Item>) entityManager.createQuery("SELECT o FROM ItemEntity o").getResultList();
    }
}
